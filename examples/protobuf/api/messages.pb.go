...
const file_api_messages_proto_rawDesc = "" +
	...
	"\x05items\x18\x01 \x03(\v2\t.api.ItemR\x05items\x12\x14\n" +
	"\x05total\x18\x02 \x01(\x05R\x05total\" \n" +
	"\x0eGetItemRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02idB/Z-github.com/broady/tygor/examples/protobuf/apib\x06proto3"
...
var file_api_messages_proto_goTypes = []any{
	(*CreateItemRequest)(nil), // 0: api.CreateItemRequest
	(*Item)(nil),              // 1: api.Item
	(*ListItemsRequest)(nil),  // 2: api.ListItemsRequest
	(*ListItemsResponse)(nil), // 3: api.ListItemsResponse
	(*GetItemRequest)(nil),    // 4: api.GetItemRequest
}
var file_api_messages_proto_depIdxs = []int32{
	1, // 0: api.ListItemsResponse.items:type_name -> api.Item
