...
| `schemas.map.zod.ts` | Schema map for regular zod |
| `schemas.map.zod-mini.ts` | Schema map for zod-mini |
...
// Use the map matching your zod flavor
import { schemaMap } from "./rpc/schemas.map.zod";
// Or for zod-mini: import { schemaMap } from "./rpc/schemas.map.zod-mini";
...
<!-- [snippet-file:client/src/rpc/schemas.map.zod.ts] -->
```typescript title="schemas.map.zod.ts"
