...
const goCode = [
  ...
  line(span('news.Register('), span('"List"', colors.string), span(', tygor.UnaryGet(ListNews))')),
  line(span('news.Register('), span('"Create"', colors.string), span(', tygor.Unary(CreateNews))')),
  line(span(' ')),
  line(span('if', colors.keyword), span(' *gen {')),
  line(span('  tygorgen.Generate(reg, &tygorgen.Config{OutDir: '), span('"..."', colors.string), span('})')),
