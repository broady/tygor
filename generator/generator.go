...
// RouteMetadata contains metadata about a registered route.
...
func Generate(routes map[string]RouteMetadata, cfg *Config) error {
	if cfg.OutDir == "" {
...
func generateManifest(outDir string, routes map[string]RouteMetadata) error {
